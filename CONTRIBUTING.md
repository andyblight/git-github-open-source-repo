NOTE: This is a copy of a real `CONTRIBUTING.md` file from the [MicroROS PlatformIO](https://github.com/pipebots/micro_ros_platformio).  You can see that there can be quite a lot of rules!
