...
1. Fork this repo to your personal GitHub user account.  See [GitHub instructions](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/fork-a-repo).  Forking the main branch only is generally a good idea, so accept the default.
